...
namespace PhoneBook.WPF.DataProvider
{
    public class ContactWebApiDataProvider : IContactDataProvider
    {
        ...
        public async Task<IEnumerable<Contact>> LoadContacts()
        {
            ...
            try
            {
                json = await _client.GetStringAsync("http://localhost:15009/api/Contacts");
            }
            catch (Exception)
            {
                json = null;
            ...
            var inMemoryContacts = new[]
                {
                new Contact{ FirstName = "Ivan", Address = "Test adres", Description = "Descr", LastName = "Ivanov", MiddleName = "Alexandrovich", Phone = "+7(777)777-77-77"},
                new Contact{ FirstName = "Ivan", Address = "Test adres", Description = "Descr", LastName = "Ivanov", MiddleName = "Alexandrovich", Phone = "+7(777)777-77-77"},
                new Contact{ FirstName = "Ivan", Address = "Test adres", Description = "Descr", LastName = "Ivanov", MiddleName = "Alexandrovich", Phone = "+7(777)777-77-77"},
                new Contact{ FirstName = "Ivan", Address = "Test adres", Description = "Descr", LastName = "Ivanov", MiddleName = "Alexandrovich", Phone = "+7(777)777-77-77"}
                };
